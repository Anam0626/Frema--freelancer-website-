        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <div class="mt-4">
                    ...
                    <select name="gender" id="inputGroupSelect" id="gender" class="block mt-1 w-full">
                ...
                <div class="mt-4">
                    <div class="mt-4">
                        <x-jet-label for="phone" value="{{ __('Phone (without 0)') }}" />
                    ...
                    <div class="mt-4">
                        <div class="mt-4">
                            ...
                            <x-jet-input id="dob" class="block mt-1 w-full" type="date" name="dob" :value="old('dob')"
                                required />
                        </div>
