...
<section class="section  bg-gray py-5">
    <div class="container">
        <div>
            <p>Welcome to Frema!</p>

            <p>These terms and conditions outline the rules and regulations for the use of Frema's Website.</p>
            ...
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
                ...
                use
                of the above terminology or other words in the singular, plural, capitalization and/or he/she or they,
                are
                taken as interchangeable and therefore as referring to same.</p>

            <h3><strong>Cookies</strong></h3>

            <p>We employ the use of cookies. By accessing Frema, you agreed to use cookies in agreement with the
                Frema's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, Frema and/or its licensors own the intellectual property rights for all
                material on Frema. All intellectual property rights are reserved. You may access this from
                Frema
                for your own personal use subjected to restrictions set in these terms and conditions.</p>

            <p>You must not:</p>
            <ul class="list-unstyled">
                <li>Republish material from Frema</li>
                <li>Sell, rent or sub-license material from Frema</li>
                <li>Reproduce, duplicate or copy material from Frema</li>
                <li>Redistribute content from Frema</li>
            </ul>


            <p>Parts of this website offer an Frema for users to post and exchange opinions and information in
                certain
                areas of the website. Frema does not filter, edit, publish or review Comments prior to their
                presence
                on the website. Comments do not reflect the views and opinions of Frema,its agents and/or
                affiliates.
                Comments reflect the views and opinions of the person who post their views and opinions. To the extent
                permitted by applicable laws, Frema shall not be liable for the Comments or for any liability,
                damages
            ...
            <p>Frema reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            <p>You hereby grant Frema a non-exclusive license to use, reproduce, edit and authorize others to use,
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                Frema; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website,
                you must inform us by sending an e-mail to Frema. Please include your name, your organization
                name,
            ...
            <p>No use of Frema's logo or other artwork will be allowed for linking absent a trademark license
                agreement.</p>
