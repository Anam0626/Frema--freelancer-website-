...
Route::middleware(['auth:sanctum', 'verified'])->get('/userTable', function () {
        return view('user');
    });

    Route::middleware(['auth:sanctum', 'verified'])->get('/admin', [CategoryController::class, 'index'])->name('dashboard');
    Route::middleware(['auth:sanctum', 'verified'])->get('/addCategory', [CategoryController::class, 'indexAddCategory'])->name('addCategory');
    Route::middleware(['auth:sanctum', 'verified'])->get('/category', [CategoryController::class, 'indexCategory'])->name('category');
    Route::middleware(['auth:sanctum', 'verified'])->get('/userTable', [UserController::class, 'index'])->name('user');
    ...
    Route::middleware(['auth:sanctum', 'verified'])->delete('/category/{id}', [SubCategoryController::class, 'destroy'])->name('category.delete');
    Route::middleware(['auth:sanctum', 'verified'])->delete('/userTable/{id}', [UserController::class, 'destroy'])->name('user.delete');
